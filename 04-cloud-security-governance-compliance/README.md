...
This project demonstrates Policy as code, compliance mapping, audit evidence, scorecards, risk management across AWS, Azure, and GCP. It is written as an enterprise-style portfolio project for cloud security engineering roles.
